/**
  ******************************************************************************
  * @file    iks02a1_mems_control_ex.c
...
{
  (void)IKS02A1_MOTION_SENSOR_Read_Register(IKS02A1_ISM330DHCX_0, Reg, Data);
}
...
{
//  (void)IKS02A1_MOTION_SENSOR_Read_Register(IKS02A1_IIS2MDC_0, Reg, Data);
}
...
{
  (void)IKS02A1_MOTION_SENSOR_Write_Register(IKS02A1_ISM330DHCX_0, Reg, Data);
}
...
{
//  (void)IKS02A1_MOTION_SENSOR_Write_Register(IKS02A1_IIS2MDC_0, Reg, Data);
}
...
void BSP_SENSOR_ACC_SetDRDYMode(uint8_t Mode)
{
  if (Mode == 1)
  {
    (void)IKS02A1_MOTION_SENSOR_DRDY_Set_Mode(IKS02A1_ISM330DHCX_0, ISM330DHCX_DRDY_PULSED);
  }
  else
  {
    (void)IKS02A1_MOTION_SENSOR_DRDY_Set_Mode(IKS02A1_ISM330DHCX_0, ISM330DHCX_DRDY_LATCHED);
  }
}
...
void BSP_SENSOR_ACC_SetDRDYInt(uint8_t Enable)
{
  ...
  (void)IKS02A1_MOTION_SENSOR_Read_Register(IKS02A1_ISM330DHCX_0, ISM330DHCX_INT1_CTRL, &reg);
  ...
  (void)IKS02A1_MOTION_SENSOR_Write_Register(IKS02A1_ISM330DHCX_0, ISM330DHCX_INT1_CTRL, reg);
}
...
{
  (void)IKS02A1_MOTION_SENSOR_Get_DRDY_Status(IKS02A1_ISM330DHCX_0, MOTION_ACCELERO, Status);
}
...
{
  (void)BSP_SENSOR_ACC_Write_Register(ISM330DHCX_FUNC_CFG_ACCESS, 0x80);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS1, &Data[0]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS2, &Data[1]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS3, &Data[2]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS4, &Data[3]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS5, &Data[4]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS6, &Data[5]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS7, &Data[6]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS8, &Data[7]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS9, &Data[8]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS10, &Data[9]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS11, &Data[10]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS12, &Data[11]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS13, &Data[12]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS14, &Data[13]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS15, &Data[14]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_FSM_OUTS16, &Data[15]);
  (void)BSP_SENSOR_ACC_Write_Register(ISM330DHCX_FUNC_CFG_ACCESS, 0x00);
}
...
{
  (void)BSP_SENSOR_ACC_Write_Register(ISM330DHCX_FUNC_CFG_ACCESS, 0x80);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC0_SRC, &Data[0]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC1_SRC, &Data[1]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC2_SRC, &Data[2]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC3_SRC, &Data[3]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC4_SRC, &Data[4]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC5_SRC, &Data[5]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC6_SRC, &Data[6]);
  (void)BSP_SENSOR_ACC_Read_Register(ISM330DHCX_MLC7_SRC, &Data[7]);
  (void)BSP_SENSOR_ACC_Write_Register(ISM330DHCX_FUNC_CFG_ACCESS, 0x00);
}
